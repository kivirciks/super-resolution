...
parser.add_argument('--input', type=str, required=False, default=(r'C:\Users\n.strokova\Downloads\super-resolution-master (3)\super-resolution-master\Photo_Color\Dog_Color.jpg'), help='input image to use')
parser.add_argument('--model', type=str, default=(r'C:\Users\n.strokova\Downloads\super-resolution-master (3)\super-resolution-master\Weight\EDSR_model_path.pth'), help='model file to use')
